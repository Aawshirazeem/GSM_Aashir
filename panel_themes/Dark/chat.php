...
<html lang="us">
    ...
    <body class="" style="padding-right:15%;background-color: ">
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="index.html" class="logo"><i class="icon-magnet icon-c-logo"></i><span><?php echo CONFIG_SITE_NAME;?><i class="md md-album"></i>LiveChat</span></a>
                </div>
            </div>
        ...
        <?php
         if (file_exists(CONFIG_PATH_CHAT_ABSOLUTE . $page . '.php')) {
                            include(CONFIG_PATH_CHAT_ABSOLUTE . $page . '.php');
                        }
