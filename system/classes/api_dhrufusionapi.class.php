...
class api_dhrufusionapi
{
    ...
    var $propRequestFormat;
    var $propAPIKey;
    var $propUsername;
    var $propURL = '';
        
        
    function __construct($requestformat, $APIKey, $Username, $URL)
    {
        $this->xmlData = new DOMDocument();
        $this->propRequestFormat = $requestformat;
        $this->propAPIKey = $APIKey;
        ...
        if (is_string($action))
        {
            if (is_array($arr))
            {
                if (count($arr))
                {
                    ...
                    'apiaccesskey' => $this->propAPIKey,
                    'action' => $action,
                   
                    'requestformat' => $this->propRequestFormat,
                ...
                curl_setopt($crul, CURLOPT_URL, $this->propURL.'/api/index.php');
