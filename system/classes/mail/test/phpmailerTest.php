...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        if (array_key_exists('mail_from', $_REQUEST)) {
            ...
            $this->Mail->From = 'system@nckcodes.net';
        }
        $this->Mail->FromName = 'Unit Tester';
        $this->Mail->Sender = 'system@nckcodes.net';
        ...
        if (array_key_exists('mail_host', $_REQUEST)) {
            ...
            $this->Mail->Host = 'box389.bluehost.com';
        }
        ...
        $this->Mail->Helo = 'box389.bluehost.com';
        $this->Mail->SMTPAuth = false;
        $this->Mail->Username = 'system@nckcodes.net';
        $this->Mail->Password = 'Sham786';
        ...
        if (array_key_exists('mail_to', $_REQUEST)) {
            $this->setAddress($_REQUEST['mail_to'], 'Test User', 'csexpert111@gmail.com');
        }
