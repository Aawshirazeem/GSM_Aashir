...
class api_lgtool_net{
    ...
    function sendCommand($command, $params = array())
    {
		if (is_string($command))
		{
			if (is_array($params))
			{
				$params['api_key'] = LGTN_API_ACCESS_KEY;
				...
				curl_setopt( $this->gf_channel, CURLOPT_URL, LGTN_API_URL );
				...
				if (LGTN_API_DEBUG && curl_errno($this->gf_channel) != CURLE_OK)
				{
