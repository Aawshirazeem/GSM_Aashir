<?php
	...
	$validator->formSetAdmin('user_group_add_54964566f45');	
?>
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_group_add_process.do" method="post">
<div class="lock-to-top">
	...
	<div class="btn-group">
		...
		<input type="submit" name="" value="<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_add')); ?>" class="btn btn-success">
	</div>
</div>
