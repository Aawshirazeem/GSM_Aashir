<?php
	...
	defined("_VALID_ACCESS") or die("Restricted Access");
		...
		$validator->formSetAdmin('services_imei_group_edit_547339932');
	...
	$sql ='select * from ' . IMEI_GROUP_MASTER . ' where id=' . $mysql->getInt($id);
...

	{
		...
		header("location:" . CONFIG_PATH_SITE_ADMIN . "services_imei_group.html?reply=" . urlencode('reply_success_invalid_id'));
...
<div class="row m-b-20">
	...
	<div class="col-xs-12">
    	...
    	<ol class="breadcrumb icon-home icon-angle-double-right animation-delay-slow">
            ...
            <li class="slideInDown wow animated"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_update_imei_service_group')); ?></li>
...
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_imei_group_edit_process.do" method="post">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="">
				...
				<h4 class="m-b-20"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_update_imei_service_group')); ?></h4>
				...
				<div class="panel-body">
					...
					<div>
						...
						<input type="submit" value="<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_update_group')); ?>" class="btn btn-success btn-sm" />
