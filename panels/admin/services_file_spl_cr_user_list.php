...
<ul class="breadcrumb">
	...
	<li><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_file.html"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_file_service_manager')); ?></a></li>
	<li class="active"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_special_credit_users')); ?></li>
</ul>
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_file_tools_spl_cr_user_process.do" enctype="multipart/form-data" method="post" name="frm_inquiry" id="frm_inquiry">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel">
				<div class="panel-heading"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_special_credit_users')); ?></div>
				...
				<div class="panel-footer">
					...
					<input type="submit" name="update" value="<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('reply_update')); ?>" class="btn btn-success" >
				</div> <!-- / panel-footer -->
			</div> <!-- / panel -->
		</div> <!-- / col-lg-6 -->
	</div> <!-- / row -->
