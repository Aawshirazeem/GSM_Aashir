...
<div class="row">
	<div class="col-lg-12">
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('reply_edit_sp_credit')); ?></li>
		</ul>
	</div>
</div>
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_imei_tools_spl_cr_user_process.do" enctype="multipart/form-data" method="post" name="frm_inquiry" id="frm_inquiry">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel">
				<div class="panel-heading"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('reply_edit_sp_credit')); ?></div>
