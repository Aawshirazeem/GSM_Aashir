...
$pCode = $paging->recordsetNav($sql, CONFIG_PATH_SITE_ADMIN . 'report_order_imei_2.html', $offset, $limit, $extraURL);
...
<div class="row m-b-20">
	...
	<div class="col-xs-12">
    	...
    	<ol class="breadcrumb icon-home icon-angle-double-right animation-delay-slow">
            ...
            <li class="slideInDown wow animated"><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>report_order_imei.html"><i class="fa fa-angle-left"></i> <?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_Main_report')); ?></a></li>           

             <li class="slideInDown wow animated active"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_Order_IMEI_Detail')); ?></li>
...
<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_IMEI_order_detail_report')); ?>
                ...
                <div class=" btn-group pull-right">
                        ...
                        <a href="#searchPanel" data-toggle="modal" class="btn btn-warning btn-xs"><i class="fa fa-search"></i> <?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_filter')); ?> </a-->	
             ...
             echo '<td>' . $row['imei'] . ' </td>';
               ...
               switch ($row['status']) {
                       ...
                       case 0:
                            ...
                            echo '<td><div class="w-100"><span class="text-default"><i class="fa fa-spinner fa-pulse text-default"></i> ' . $lang->get('com_New_Order') . '</span></div></td>';

                            break;

                        case 1:

                            echo '<td><div class="w-100"><span class="text-primary"><i class="fa fa-lock text-primary"></i> ' . $lang->get('lbl_In-Process') . '</span></div></td>';

                            break;

                        case 2:

                            echo '<td><div class="w-100"><span class="text-success"><i class="fa fa-circle text-success"></i> ' . $lang->get('com_Completed') . '</span></div></td>';

                            break;

                        case 3:

                            echo '<td><div class="w-100"><span class="text-danger"><i class="fa fa-circle text-danger"></i> ' . $lang->get('com_rejected') . '</span></div></td>';
