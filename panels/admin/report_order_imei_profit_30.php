...
cast(a.date_time as date) BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW()
and a.`status`=2
and a.credits!=0
...
where cast(a.date_time as date) BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW()
...
<?php echo $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_LAST_30_DAYS_PROFIT_IMEI')); ?>

        <div class="btn-group pull-right">

            <a href="report_order_imei_profit.html" class="btn btn-default btn-sm"><?php echo $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_Today')); ?></a>

            <a href="report_order_imei_profit_7.html" class="btn btn-default btn-sm"><?php echo $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_LAST_7_DAYS')); ?></a>

            <a href="report_order_imei_profit_30.html" class="btn btn-primary btn-sm"><?php echo $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_LAST_30_DAYS')); ?></a>
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <label><?php $lang->prints('lbl_supplier'); ?> </label>

                            <select name="search_supplier_id" class="form-control">

                                <option value="0"><?php $lang->prints('lbl_all_suppliers'); ?> </option>
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" value="<?php $lang->prints('lbl_search'); ?>" class="btn btn-success" />
    ...
    <div class="col-md-12">
        ...
        <div id="report_order_imei_profit_30" class="graph" ></div><br>
    ...
    <table class="MT5 table table-striped table-hover panel">
        ...
        <tr>
            ...
            <th><?php $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_tool')); ?></th>

            <th><?php $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_No.Tr')); ?></th>

            <th><?php $admin->wordTrans($admin->getUserLang(), $lang->prints('com_profit')); ?></th>
...
<script type="text/javascript">
    ...
    var _sfunc = function () {
        ...
        Morris.Donut({
            element: 'report_order_imei_profit_30',
            data: [
<?php
$str = '';
