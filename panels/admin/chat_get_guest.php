...
,b.username adminname,c.username,c.img
from " . Chat_Box . " a
...
where b.entry_type='admin' and b.isview=0 
and user_id=" . $user_id . " and admin_id=" . $admin_id;
//echo $sql;exit;
...
if ($result['COUNT']) {
    ...
    foreach ($result['RESULT'] as $row) {
        $msgid.=$row['a_id'] . ',';
        // $newDateTime = date('l  \, F j\, Y h:i A', strtotime($row['time_stamp']));
        // echo $newDateTime;
