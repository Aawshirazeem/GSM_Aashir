...
<div class="row m-b-20">
    ...
    <div class="col-xs-12">
        ...
        <ol class="breadcrumb icon-home icon-angle-double-right animation-delay-slow">
            ...
            <li class="slideInDown wow animated active"><?php echo $admin->wordTrans($admin->getUserLang(), $lang->prints('lbl_IMEI_Orders')); ?></li>
...
<div class="btn-group btn-group-sm extra">
    ...
    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>report_order_imei.html" class="btn btn-primary"><?php echo $admin->wordTrans($admin->getUserLang(), $lang->prints('com_IMEI_Orders')); ?> </a>
...
<div class="row">
	...
	<div class="">
		...
		<h4 class="panel-heading m-b-20">
			...
			<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_IMEI_order_report_all')); ?>
			...
			<div class=" btn-group pull-right">
				...
				<?php if($clearSearch == true){ ?><a href="<?php echo CONFIG_PATH_SITE_ADMIN?>report_order_imei.html" class="btn btn-danger btn-xs"><i class="fa fa-undo"></i></a> <?php } ?>
		...
		<table class="table table-striped table-hover">
			...
			<tr>
				...
				<th><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_orders')); ?></th>
                                ...
                                <th><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_Details')); ?></th>
						...
						echo '<tr>';
							...
							//{ 
								...
								echo '<td>' . $row['orders'] . ' </td>';
                                                               ...
                                                               echo '<td><div class="w-100"><a href="'.CONFIG_PATH_SITE_ADMIN.'report_order_imei_2.html?tool='.$row['id'].'" style="color: #337ab7 !important;text-decoration: none;"">'.$admin->wordTrans($admin->getUserLang(),$lang->get('lbl_Detail_Report')).'</a></div></td>';
