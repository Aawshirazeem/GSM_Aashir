...
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>product_add_process.do" method="post" enctype="multipart/form-data">

    <div class="row">
        <div class="col-md-6 col-sm-offset-3">
            <div class="panel">
                <div class="panel-heading"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_Product_details')); ?></div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="s_number" type="text" class="form-control" id="s_number" value="" required />
                    </div>
                    <div class="form-group">
                        <label><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_part_number')); ?></label>
                        <input name="p_number" type="text" class="form-control" id="p_number" value="" required />
                    </div>
                    <div class="form-group">
                        <label><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_cost')); ?></label>
                        <input name="cost" type="text" class="form-control" id="cost" value="" required />
                    </div>
                    <div class="form-group">
                        <label><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_default_price')); ?></label>
                        <input name="def_price" type="text" class="form-control" id="def_price" value="" />
                    </div>
                     <div class="form-group">
                        <label><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_minimum_price')); ?></label>
                        <input name="min_price" type="text" class="form-control" id="min_price" value="" />
                    </div>
                     <div class="form-group">
                        <label><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_warrenty')); ?></label>
                        <input name="warrenty" type="checkbox" class="" id="warrenty" value="1" />
                    </div>
                     <div class="form-group">
