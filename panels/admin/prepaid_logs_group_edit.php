<?php
	...
	$validator->formSetAdmin('con_pre_log_group_edit_1488734312');
	...
	$sql ='select * from ' . PREPAID_LOG_GROUP_MASTER . ' where id=' . $mysql->getInt($id);
...
<div class="row m-b-20">
	...
	<div class="col-xs-12">
    	...
    	<ol class="breadcrumb icon-home icon-angle-double-right animation-delay-slow">
            ...
            <li class="slideInDown wow animated active"><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>prepaid_logs_group.html"> <?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_manage_groups')); ?></a></li>
...
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>prepaid_logs_group_edit_process.do" method="post">
			...
			<div class="">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<input type="submit" class="btn btn-success btn-sm"  value="<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('com_update_group')); ?>" />
