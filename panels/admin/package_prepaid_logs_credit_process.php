...
$sql_tools = 'select id from ' . PREPAID_LOG_MASTER;
...
$sql_1 = 'delete from  ' . PACKAGE_PREPAID_LOG_DETAILS . ' where package_id=' . $package_id;
$mysql->query($sql_1);

$sql = 'insert into ' . PACKAGE_PREPAID_LOG_DETAILS . '
