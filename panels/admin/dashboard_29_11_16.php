                    	...
                    	<div class="col-xs-12">
                        	<ul class="list-group">
                            	<li class="list-group-item success">
                                    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>report_admin_login_log.html" class="btn btn-default btn-outline pull-right btn-sm parentOpen" style="margin-top: -5px;"><i class="fa fa-long-arrow-right"></i></a>
                                	<span class="text-uppercase text-bold"><?php $lang->prints('lbl_Login_Log'); ?></span>
                                </li>
                                <li class="list-group-item success">
                                    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_credit_invoices.html?status=0" class="btn btn-default btn-outline pull-right btn-sm parentOpen" style="margin-top: -5px;"><i class="fa fa-long-arrow-right"></i></a>
                                	<span class="text-uppercase text-bold"><?php $lang->prints('lbl_Unpaid_Invoices'); ?></span>
                                </li>
                                <li class="list-group-item success">
                                    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>email_user_list.html" class="btn btn-default btn-outline pull-right btn-sm parentOpen" style="margin-top: -5px;"><i class="fa fa-long-arrow-right"></i></a>
                                	<span class="text-uppercase text-bold"><?php $lang->prints('lbl_Mass_Email'); ?></span>
                                </li>
                                <li class="list-group-item success">
                                    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users.html" class="btn btn-default btn-outline pull-right btn-sm parentOpen" style="margin-top: -5px;"><i class="fa fa-long-arrow-right"></i></a>
                                	<span class="text-uppercase text-bold"><?php $lang->prints('lbl_User_Manage'); ?></span>
                                </li>
                                <li class="list-group-item success">
                                    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>api_list.html" class="btn btn-default btn-outline pull-right btn-sm parentOpen" style="margin-top: -5px;"><i class="fa fa-long-arrow-right"></i></a>
                                	<span class="text-uppercase text-bold"><?php $lang->prints('lbl_Api_Setting'); ?></span>
                                </li>
                                <li class="list-group-item success">
                                    <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_imei_tools.html" class="btn btn-default btn-outline pull-right btn-sm parentOpen" style="margin-top: -5px;"><i class="fa fa-long-arrow-right"></i></a>
        ...
        <div class="row m-b-10">
        	<div class="col-xs-12 col-md-4">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-scale from-left">
                    	<a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_imei.html?type=pending"><b><?php $lang->prints("lbl_New"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $imineword; ?></span></a>
                        <a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_imei.html?type=locked"><b><?php $lang->prints("lbl_In-Process"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $imiinprocess; ?></span></a>
                        <?php if ($imiverfify != 0) { ?>
                        <a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_imei.html?type=verify"><b><?php $lang->prints("lbl_Verification"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $imiverfify; ?></span></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-4">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-scale from-left">
                    	<a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_server_log.html?type=pending"><b><?php $lang->prints("lbl_New"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $servneword; ?></span></a>
                        <a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_server_log.html?type=locked"><b><?php $lang->prints("lbl_In-Process"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $servinprocess; ?></span></a>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-4">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-scale from-left">
                    	<a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_file.html?type=pending"><b><?php $lang->prints("lbl_New"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $fileneword; ?></span></a>
                        <a class="dropdown-item parentOpen" href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>order_file.html?type=locked"><b><?php $lang->prints("lbl_In-Process"); ?></b> <span class="m-r-10 label label-rounded label-primary-outline"><?php echo $fileinprocess; ?></span></a>
                    </div>
                </div>
            </div>
        </div>
