...
<div class="m-t-10">
    ...
    <table class="table table-hover table-striped">
    	<tr>
            ...
            <th width=""><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_meta')); ?></th>
...
union 
select * from ' . CMS_PAGE_MASTER.' a
where (a.title not like "Footer%")

 and (a.title not like "Home%")' ;
		...
		?>
        	...
        	<tr>
                ...
                <td>
					...
					?>
                    	<button type="button" class="btn btn-sm btn-grey btnChangeHome" data-id="<?php echo $row['id']; ?>"><i class="fa fa-check"></i></button>
                    <?php
						}
                ...
                <td>
                	<a href="<?php echo '../cms.html?id=' . $row['id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                	<a href="<?php echo '../'.$row['url'].'.html'; ?>" target="_blank">
                    	<button type="button" class="btn btn-sm btn-default"><i class="fa fa-eye"></i></button>
                    </a>
                    <?php if($row['id'] != 1 && $row['id'] != 2 && $row['id'] != 16 && $row['id'] != 19){ ?>
