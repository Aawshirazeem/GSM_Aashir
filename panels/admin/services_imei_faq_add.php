<?php
	...
	$validator->formSetAdmin('services_imei_faq_add_75566355454');
?>
<div class="row">
	<div class="col-lg-12">
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo $admin->wordTrans($admin->getUserLang(),'Add New FAQ'); ?></li>
		</ul>
	</div>
</div>
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_imei_faq_add_process.do" method="post">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<a href="<?php echo CONFIG_PATH_SITE_ADMIN;?>services_imei_faq.html" class="btn btn-danger btn-sm"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_cancel')); ?></a>
						<input type="submit" class="btn btn-success btn-sm" value="<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_add_faq')); ?>" />
					</div>
				</div> <!-- / panel-body -->
 <!-- / panel-footer -->
			</div> <!-- / panel -->
