...
define('DHRUFUSION_URL', "http://imei.pk/");
define("USERNAME", "test");
define("API_ACCESS_KEY", "ZN63-PHBA-VC4T-W7YY");


/*
define("REQUESTFORMAT", "JSON"); // we recommend json format (More information http://php.net/manual/en/book.json.php)
define('DHRUFUSION_URL', "www.allgsmservice.biz");
define("USERNAME", "GsmNafees");
define("API_ACCESS_KEY", "6ZA-XQ2-X8V-TDZ-NA9-4B8-5WE-4NE");
*/
