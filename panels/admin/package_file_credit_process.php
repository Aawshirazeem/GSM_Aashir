...
$sql_tools = 'select id from ' . FILE_SERVICE_MASTER;
...
$sql_1 = 'delete from  ' . PACKAGE_FILE_DETAILS . ' where package_id=' . $package_id;
$mysql->query($sql_1);

$sql = 'insert into ' . PACKAGE_FILE_DETAILS . '
			(package_id,currency_id,service_id,amount)
			values';
