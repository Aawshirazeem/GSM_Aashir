...
<div class="row m-b-20">
	...
	<div class="col-xs-12">
    	...
    	<ol class="breadcrumb icon-home icon-angle-double-right animation-delay-slow">
            ...
            <li class="slideInDown wow animated"><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users.html"><?php $lang->prints('lbl_users'); ?></a></li>

            <li class="slideInDown wow animated active"><?php $lang->prints('lbl_Edit User'); ?></li>
    	...
    	<div class="row">
        	...
        	<div class="col-xs-12">
            	...
            	<div class="stats pull-right m-t-30 w-600 color-white">
                	...
                	<div class="pull-left w-200 text-center">
                        ...
                        <p class="text-sm"><?php $lang->prints('lbl_credits'); ?></p>
                    ...
                    <div class="pull-left w-200 text-center">
                        ...
                        <p class="text-sm"><?php $lang->prints('lbl_in_process'); ?></p>
                    ...
                    <div class="pull-left w-200 text-center">
                    	...
                    	<h3 class="text-bold"> <?php echo $objCredits->printCredits($row['credits_used'], $prefixD, $suffixD);?> </h3>
                      	...
                      	<p class="text-sm"><?php $lang->prints('lbl_used'); ?></p>
                ...
                <div class="media"> 
                    ...
                    <div class="media-body">
                        ...
                        <div class="profile-buttons">
                            ...
                            <a target="_blank" href="<?php echo CONFIG_PATH_SITE_USER;?>login_key_process.do?key=<?php echo $row['login_key']?>" class="btn mini btn-success btn-sm btn-flat"><?php $lang->prints('lbl_Login'); ?></a>

                            <?php } ?>

                            <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_delete.html?id=<?php echo $id; ?>" class="btn mini btn-danger btn-sm btn-flat"><i class="fa fa-times"> <?php $lang->prints('lbl_Delete User'); ?> </i></a>             
            ...
            <div class="col-xs-12">
            	...
            	<div class="btn-group btn-sm">
                	...
                	<a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users.html" class="btn btn-primary-100"><?php $lang->prints('lbl_Go To Users'); ?></a>

                    <a href="<?php CONFIG_PATH_SITE_ADMIN;?>users_credit_invoices_userwise.html?status=0&id=<?php echo $row['id'];?>" class="btn btn-success-100"><?php $lang->prints('lbl_Invoices'); ?></a>

                    <a href="<?php CONFIG_PATH_SITE_ADMIN;?>users_credits.html?id=<?php echo $row['id'];?>" class="btn btn-warning-100"><?php $lang->prints('lbl_Credit'); ?></a>

                    <?php if($row['status'] != 1){ ?>

                    <a href="<?php CONFIG_PATH_SITE_ADMIN;?>users_reactive.html?id=<?php echo $row['id'];?>" class="btn btn-success"><?php $lang->prints('lbl_Unblock/Active'); ?></a>

                    <?php } ?>

                    <button class="btn btn-info-100" name="user_password" id="user_password"><?php $lang->prints('lbl_Generate Password & Send Mail'); ?></button>
    	...
    	<div class="bs-nav-tabs nav-tabs-warning">
        	...
        	<ul class="nav nav-tabs nav-animated-border-from-left">
            	...
            	<li class="nav-item"> 
                	...
                	<a class="nav-link active" data-toggle="tab" data-target="#nav-tabs-0-1"><?php $lang->prints('lbl_overview'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-2"><i class="fa fa-lock"></i> <?php $lang->prints('lbl_login'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-3"><?php $lang->prints('lbl_profile'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-4"><?php $lang->prints('com_payment'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-5"><?php $lang->prints('com_imei'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-6"><?php $lang->prints('com_file'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-7"><?php $lang->prints('com_server_log'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-8"><?php $lang->prints('com_prepaid_log'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-9"><?php $lang->prints('lbl_ip_setting'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-10"><?php $lang->prints('lbl_Invoices'); ?></a> 

                </li>

                <li class="nav-item"> 

                	<a class="nav-link" data-toggle="tab" data-target="#nav-tabs-0-11"><?php $lang->prints('lbl_email_log'); ?></a> 
            ...
            <div class="tab-content">
            	...
            	<div role="tabpanel" class="tab-pane in active" id="nav-tabs-0-1">
                	...
                	<div class="p-t-20">
                    	...
                    	<h5><?php $lang->prints('lbl_order_summary'); ?></h5>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_password'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_email'); ?></label>
                                         ...
                                         <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_overdrive_limit'); ?></label>
...
<!--                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('lbl_alternate_emails'); ?><br></label>
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <label><?php $lang->prints('com_account_suspension_days'); ?><br></label>

                                    <input name="account_suspension_days" type="text" class="form-control" id="email" value="<?php echo $row['account_suspension_days'] ?>" />

                                    <p class="help-block"><?php $lang->prints('lbl_note:_these_are_the_days_upto_which_the_user_account_be_active'); ?></p>

                                </div>

<!--                                <div class="form-group">

                                    <label><?php $lang->prints('com_credits_transaction_limit'); ?><br></label>
                                ...
                                <div class="form-group ">
                                    ...
                                    <label><?php $lang->prints('lbl_user_type'); ?><br></label>
                                    ...
                                    <div class="checkboxes">
                                        ...
                                        <label class="c-input c-radio"><input type="radio" name="user_type" value="0" <?php echo (($row['user_type'] == '0') ? 'checked="checked"' : ''); ?> /> <i class="fa fa-user"></i> <?php $lang->prints('com_user'); ?> [<?php $lang->prints('lbl_can_order_any_service_as_per_user_rights'); ?>]<span class="c-indicator c-indicator-success"></span></label>

                                      <?php if($is_access==1) { ?>

                                        <label class="c-input c-radio"><input type="radio" name="user_type" value="1" <?php echo (($row['user_type'] == '1') ? 'checked="checked"' : ''); ?>  /> <i class="fa fa-group"></i> <?php $lang->prints('com_reseller'); ?> [<?php $lang->prints('lbl_has_all_facilites_like_a_user,_but_can_create/manage_his_own_customers'); ?>]<span class="c-indicator c-indicator-success"></span></label>
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <label><?php $lang->prints('lbl_imei_service_access'); ?></label>
                                        ...
                                        <div class="col-sm-3">
                                        	...
                                        	<label><?php $lang->prints('lbl_file_system_access'); ?></label>
                                        ...
                                        <label><?php $lang->prints('lbl_server_logs_access'); ?></label>
                                        ...
                                        <label><?php $lang->prints('lbl_prepaid_logs_access'); ?></label>
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <label><?php $lang->prints('lbl_online_store_access'); ?></label>

                                    <label class="checkbox-inline c-input c-radio">

                                     

                                        <input type="radio" name="service_shop" value="1" <?php echo (($row['service_shop'] == '1') ? 'checked="checked"' : ''); ?> /> <?php $lang->prints('com_yes'); ?><span class="c-indicator c-indicator-success"></span>

                                    </label>

                                    <label class="checkbox-inline c-input c-radio">

                                        <input type="radio" name="service_shop" value="0" <?php echo (($row['service_shop'] == '0') ? 'checked="checked"' : ''); ?> /> <?php $lang->prints('com_no'); ?><span class="c-indicator c-indicator-success"></span>

                                    </label>

                                    <p class="help-block"><?php $lang->prints('lbl_is_user_can_purchase_any_services/products_from_online_store?'); ?></p>
...
<!--                                    <div class="col-sm-6">
                                        ...
                                        <label><?php $lang->prints('lbl_api_access'); ?><br></label>
                            	...
                            	<div class="form-group">
                                	...
                                	<input type="submit" value="<?php $lang->prints('lbl_update_login_details'); ?>" class="btn btn-success">
                    	...
                    	<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_edit_profile_process.do" method="post">
                            ...
                            <input name="email" type="hidden" class="textbox_fix" id="email" value="<?php echo $row['email'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_first_name'); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_last_name'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label><?php $lang->prints('lbl_company'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label><?php $lang->prints('com_address'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('lbl_city'); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_country'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <label><?php $lang->prints('lbl_language'); ?></label>

                                            <select name="language" class="form-control" id="language">

                                                <option value=""><?php $lang->prints('lbl_select_language'); ?></option>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <label><?php $lang->prints('lbl_time_zone'); ?></label>

                                            <select name="timezone" class="form-control" id="timezone">

                                                <option value=""><?php $lang->prints('lbl_select_time_zone'); ?></option>
                                        ...
                                        <div class="col-sm-4"  >
                                            ...
                                            <label><?php $lang->prints('lbl_currency'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_phone'); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label><?php $lang->prints('com_mobile'); ?></label>
                                ...
                                <div class="form-group">
                                	...
                                	<input type="submit" value="<?php $lang->prints('lbl_update_profile'); ?>" class="btn btn-success"/>
                	...
                	<div class="p-t-20">
                            ...
                            <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_edit_payment_gateway_process.do" method="post">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php $lang->prints('lbl_gateway'); ?></th>

                                        <th><?php $lang->prints('lbl_charges'); ?></th>

                                        <th><?php $lang->prints('lbl_pay_charges'); ?></th>

                                        <th width="100" class="TA_C">

                                            <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_edit_auto_pay.do?enable=<?php echo (($auto_pay == 1) ? 0 : 1 ); ?>&id=<?php echo $row['id']; ?>" class="btn btn-sm <?php echo ($auto_pay == 1) ? 'btn-danger' : 'btn-warning'; ?>"><?php echo (($auto_pay == 1) ? $lang->prints('lbl_Disable Auto-Pay') : $lang->prints('lbl_Enable Auto-Pay')); ?></a>
                                  ...
                                  //  echo $sql_pg;
                                    ...
                                    if ($mysql->rowCount($query_pg) > 0) {
                                        ...
                                        echo '<tr><td colspan="8" class="no_record">' . $lang->get('com_no_record_found') . '</td></tr>';
                                ...
                                <div class="btn-group">
                                    ...
                                    <input type="submit" value="<?php $lang->prints('com_update'); ?>" class="btn btn-success"/>
                        ...
                        <div class="row m-b-20">
                            ...
                            <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_edit_package_process.do" enctype="multipart/form-data" method="post">
                                ...
                                <h3><?php $lang->prints('lbl_user_package'); ?> </h3>
                                ...
                                <table class="MT5 table table-striped table-hover panel">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php $lang->prints('lbl_view_pa_name'); ?></th>
                                    ...
                                    if ($mysql->rowCount($query_sp) > 0) {
                                        ...
                                        echo '<tr><td><b>' . $lang->get('lbl_pa_none') . '</b></td><td><label class="c-input c-radio"><input type="radio" class="checkbox-inline" name="package_id" value="0"' . (($package_id_check == 0) ? ' checked="checked"' : '') . '/><span class="c-indicator c-indicator-success"></span></td></tr>';
                                ...
                                <div class="btn-group">
                                    ...
                                    <input type="submit" name="allot" value="<?php $lang->prints('lbl_pa_allot'); ?>" class="btn btn-success">
                        ...
                        -->
                            ...
                            <h3><?php $lang->prints('lbl_Credit purchase request'); ?></h3>
                            ...
                            <table class="MT5 table table-striped table-hover panel">
                                ...
                                <tr>
                                    ...
                                    <th ><?php $lang->prints('com_username'); ?></th>

                                    <th ><?php $lang->prints('com_date'); ?></th>

                                    <th width="100"><?php $lang->prints('com_amount'); ?></th>

                                    <th><?php $lang->prints('com_credits'); ?></th>

                                    <th><?php $lang->prints('com_status'); ?></th>
                                ...
                                if ($mysql->rowCount($query) > 0) {
                                    ...
                                    foreach ($rows_req as $row_req) {
                                        ...
                                        <td>
                                            ...
                                            switch ($row_req['status']) {
                                                ...
                                                case '0':
                                                    ...
                                                    echo $lang->get('com_pending');

                                                    break;

                                                case '1':

                                                    echo $lang->get('lbl_done');

                                                    break;

                                                case '2':

                                                    echo $lang->get('lbl_canceled');
                                        ...
                                        if ($row_req['status'] == 0) {
                                            ...
                                            <a href="' . CONFIG_PATH_SITE_ADMIN . 'users_credits.html?id=' . $row_req['user_id'] . '&irid=' . $row_req['id'] . '&credits=' . $row_req['credits'] . '" class="btn btn-primary btn-xs">'.$lang->get('lbl_Accept').'</a>

                                            <a href="' . CONFIG_PATH_SITE_ADMIN . 'invoice_request.html?inidr=' . $row_req['id'] . '" class="btn btn-default btn-xs" >'.$lang->get('lbl_Reject').'</a>
                ...
                <div role="tabpanel" class="tab-pane" id="nav-tabs-0-5">
                	...
                	<div class="p-t-20">
                        ...
                        if ($row['service_imei'] == '1') {
                            ...
                            echo '<a href="' . CONFIG_PATH_SITE_ADMIN . 'users_edit_imei_process.do?id=' . $id . '&enable=0" class="btn btn-danger m-b-10">' . $lang->get('lbl_disable') . '</a>';

                        } else {

                            echo '<a href="' . CONFIG_PATH_SITE_ADMIN . 'users_edit_imei_process.do?id=' . $id . '&enable=1" class="btn btn-success btn-lg btn-block m-b-10">' . $lang->get('lbl_enable') . '</a>';
                            ...
                            <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_spl_credits_process.do" enctype="multipart/form-data" method="post">
                                ...
                                <table class="MT5 table table-striped table-hover panel">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php $lang->prints('com_tool'); ?></th>

                                        <th class="text-right"><?php $lang->prints('lbl_credits'); ?></th>

                                        <th class="text-right" width="120"><?php $lang->prints('lbl_pack_cr'); ?></th>

                                        <th class="text-right" width="120"><?php $lang->prints('lbl_spl_cr'); ?></th>
...
//echo $sql_spl_imei;exit;
                                ...
                                <div class="btn-group">
                                    ...
                                    <input type="submit" value="<?php $lang->prints('lbl_update_credits'); ?>" class="btn btn-success"/>
                            ...
                            <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_spl_credits_file_process.do" enctype="multipart/form-data" method="post">
                                ...
                                <table class="MT5 table table-striped table-hover panel">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php $lang->prints('com_file_service'); ?></th>

                                        <th class="text_right"><?php $lang->prints('lbl_org._cr.'); ?></th>

                                        <th class="text_right" width="120"><?php $lang->prints('lbl_pack_cr'); ?></th>

                                        <th class="text_right" width="120"><?php $lang->prints('lbl_spl_cr'); ?></th>
                ...
                <div role="tabpanel" class="tab-pane" id="nav-tabs-0-7">
                	...
                	<div class="p-t-20">
                        ...
                        if ($row['service_logs'] == '1') {
                            ...
                            echo '<a href="' . CONFIG_PATH_SITE_ADMIN . 'users_edit_log_process.do?id=' . $id . '&enable=0" class="btn btn-danger m-b-10">' . $lang->get('com_disable') . '</a>';

                        } else {

                            echo '<a href="' . CONFIG_PATH_SITE_ADMIN . 'users_edit_log_process.do?id=' . $id . '&enable=1" class="btn btn-success btn-lg btn-block m-b-10">' . $lang->get('com_enable') . '</a>';
                            ...
                            <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_spl_credits_server_log_process.do" enctype="multipart/form-data" method="post">
                                ...
                                <table class="MT5 table table-striped table-hover panel">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align:right"><?php $lang->prints('lbl_org._cr.'); ?></th>

                                        <th style="text-align:right" width="120"><?php $lang->prints('lbl_pack_cr'); ?></th>

                                        <th style="text-align:right" width="120"><?php $lang->prints('lbl_spl_cr'); ?></th>
                ...
                <div role="tabpanel" class="tab-pane" id="nav-tabs-0-8">
                	...
                	<div class="p-t-20">
                        ...
                        if ($row['service_prepaid'] == '1') {
                            ...
                            echo '<a href="' . CONFIG_PATH_SITE_ADMIN . 'users_edit_prepaid_process.do?id=' . $id . '&enable=0" class="btn btn-danger m-b-10">' . $lang->get('com_disable') . '</a>';

                        } else {

                            echo '<a href="' . CONFIG_PATH_SITE_ADMIN . 'users_edit_prepaid_process.do?id=' . $id . '&enable=1" class="btn btn-success btn-lg btn-block m-b-10">' . $lang->get('com_enable') . '</a>';
                    	...
                    	<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>users_edit_profile_process2.do" method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                	...
                                	<label><?php $lang->prints('lbl_api_access'); ?></label>
                                ...
                                <div class="" id="api_key" <?php echo ($row['api_access'] != '1') ? 'hidden' : ''; ?>>

                                    <label><?php $lang->prints('lbl_API KEY'); ?></label>

                                    <input name="key" type="text" class="form-control" id="key" value="<?php echo $mysql->prints($row['api_key']) ?>" /><br/>

                                    <input type="button" value="<?php $lang->prints('lbl_Regenerate API Key'); ?>" id="btn_reg" class="btn btn-success" onclick="reset_key();" />
                                ...
                                <div>
                                    ...
                                    <br/><br/><label><?php $lang->prints('lbl_IP LIST'); ?></label><br/>
                ...
                <div role="tabpanel" class="tab-pane" id="nav-tabs-0-10">
                	...
                	<div class="p-t-20">
                    	...
                    	<h4><?php $lang->prints('lbl_User Invoices'); ?> </h4>

                        <table class="table table-hover table-striped" id ="mytbl">

                        	<tr>

                            	<th width="50"><?php $lang->prints('lbl_Status'); ?></th>

                                <th ><?php $lang->prints('lbl_date'); ?></th>

                                <th width="180"><?php $lang->prints('lbl_Admin Note'); ?></th>

                                <?php if($status==0){ ?>

                                <th width="100"><?php $lang->prints('lbl_amount'); ?></th>

                                <th width="40"><?php $lang->prints('lbl_Edit'); ?></th>

                                <?php } ?>

                                <th><?php $lang->prints('lbl_credits'); ?></th>

                                <?php if($status==0 || $status==1){ ?>

                                <th width="180"><?php $lang->prints('lbl_Action'); ?></th>
...
//                                                             }
										...
										<?php
											...
											echo '<td><div class="btn-group"><a href="' . CONFIG_PATH_SITE_ADMIN . 'users_credit_invoices_detail.html?id=' . $row['id'] . '&type=0" class="btn btn-primary btn-sm">' . $lang->get('lbl_View') . '</a> </td>';
...
//var myBarChart = new Chart(ctx).Bar(LineChart);

                                       // var myDoughnutChart = new Chart(ctx).Doughnut(data);

//var myNewChart = new Chart(ctx).PolarAr11ea(data);
...
<script>
	...
	$.ajax({
     ...
     function change(p){
		...
		if(document.getElementById('api_access').checked){
