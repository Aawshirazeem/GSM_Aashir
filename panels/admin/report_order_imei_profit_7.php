...
<div class="row">
    <div class="m-b-20">
        <?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_LAST_7_DAYS_PROFIT_IMEI')); ?>
        <div class="btn-group pull-right">
            ...
            <a href="report_order_imei_profit_7.html" class="btn btn-primary btn-sm"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_LAST_7_DAYS')); ?></a>
            <a href="report_order_imei_profit_30.html" class="btn btn-default btn-sm"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_LAST_30_DAYS')); ?></a>
        </div>
    </div>
    ...
    <!-- Chart -->
    <div class="col-sm-12">
        <div id="hero-bar" class="graph" ></div><br>
    </div>
    <!-- End Chart -->
...
where
cast(a.date_time as date) BETWEEN DATE_SUB(NOW(), INTERVAL 7 DAY) AND NOW()
...
where cast(a.date_time as date) BETWEEN DATE_SUB(NOW(), INTERVAL 7 DAY) AND NOW()
and a.`status`=2 and a.credits!=0 
