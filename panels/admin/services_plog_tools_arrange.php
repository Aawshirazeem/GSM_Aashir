...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>prepaid_logs.html"><?php $lang->prints('lbl_prepaid_log_manager'); ?></a></li>
    <li class="active"><?php $lang->prints('lbl_prepaid_log_tools_sort'); ?></li>
</ul>
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel">
            <div class="panel-heading">
                <?php $lang->prints('lbl_tools'); ?>

            </div>
            <div class="panel-body">
                <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_plog_tools_arrange_process.do" method="post">
                    ...
                    <div class="dd nestable_list" data-output="nestable_list_1_output">
                        ...
                        <ol class="dd-list">
                            ...
                            $sql = 'select itm.*,
											...
											from ' . PREPAID_LOG_MASTER . ' itm
											
											
											left join ' . PREPAID_LOG_GROUP_MASTER . ' igm on(itm.group_id = igm.id)
											where itm.group_id=' . $id . '
											order by itm.sort_order, igm.group_name, itm.prepaid_log_name';
                            //  echo $sql;
                            ...
                            if ($mysql->rowCount($query) > 0) {
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    echo '<li class="dd-item" data-id="' . $mysql->prints($row['id']) . '"><div class="dd-handle">' . $mysql->prints($row['prepaid_log_name']) . '</div></li>';
                                }
                            } else {
                        ...
                        <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>prepaid_logs.html" class="btn btn-danger">Cancel</a>
