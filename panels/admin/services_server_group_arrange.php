...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>server_logs.html"><?php $lang->prints('lbl_server_logs'); ?></a></li>
    <li class="active"><a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>server_logs_group.html"><?php $lang->prints('lbl_server_logs_groups'); ?></a></li>
    <li class="active"><?php $lang->prints('lbl_server_group_sort'); ?></li>
</ul>
<form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>services_server_group_arrange_process.do" method="post">
    <div class="row">
        <div class="col-md-8">
            <div class="">
                <h4 class="panel-heading m-b-20">
                    <?php $lang->prints('lbl_server_group_manager'); ?>
                    <div class="btn-group pull-right">
                        <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>server_logs_group.html" class="btn btn-danger btn-sm">Cancel</a>
                    </div>
                </h4>
                <div class="panel-body">
                    <div class="dd nestable_list" data-output="nestable_list_1_output">
                        ...
                        <ol class="dd-list">
                            <?php
                            $sql = 'select *, (select count(id) from ' . SERVER_LOG_MASTER . ' itm where itm.group_id=igm.id) as total from ' . SERVER_LOG_GROUP_MASTER . ' igm order by sort_order';
                            //    echo $sql;
                        ...
                        <a href="<?php echo CONFIG_PATH_SITE_ADMIN; ?>server_logs_group.html" class="btn btn-danger">Cancel</a>
