<?php
	...
	$myfile = fopen("sendmail.txt", "w") or die("Unable to open file!");
	...
	if($AvailIds != '')
	{
		...
		if($mysql->rowCount($query) > 0)
		{
			...
			//fwrite($myfile,$simple_email_body);		
			...
			$new_orders_array = array();
					...
					//fwrite($myfile,'TEMP----'.$simple_email_body);
