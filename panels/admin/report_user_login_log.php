...
<div class="row m-b-20">
	...
	<div class="col-xs-12">
    	...
    	<ol class="breadcrumb icon-home icon-angle-double-right animation-delay-slow">
            ...
            <li class="slideInDown wow animated">Reports <?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_user_login_log')); ?></li>           

             <li class="slideInDown wow animated active"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_user_login_log')); ?></li>
	...
	<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="searchPanel" class="modal fade">
		...
		<div class="modal-dialog">
		  ...
		  <form action="<?php echo CONFIG_PATH_SITE_ADMIN; ?>report_user_login_log.html" method="get">
	...
	<div class="WD60 FC">
		...
		<?php
...

			{
				...
				echo $graphics->messageBox('<a href="' . CONFIG_PATH_SITE_ADMIN . 'report_user_login_log.html">'.$msg .'</a>');
	...
	<div class="col-sm-12">		
		...
		<div class="">
			...
			<h4 class="panel-heading m-b-20">
				...
				<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_user_login_log')); ?>
				...
				<?php if($clearSearch == true){ ?><a href="<?php echo CONFIG_PATH_SITE_ADMIN?>report_user_login_log.html" class="btn btn-danger btn-xs pull-right"><i class="fa fa-undo"></i></a> <?php } ?>
			...
			<table class="table table-striped table-hover">
				...
				<?php
					...
					$sql = 'select *
							...
							from ' . STATS_USER_LOGIN_MASTER .' '. $qType .' 
				...
				?>
							...
							<tr>
								...
								<td><?php echo $finaldate = $admin->datecalculate($login['date_time']);?></td>
