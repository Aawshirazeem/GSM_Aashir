...
<div class="bg_blue">
	<div class="container">
		...
		<h3 class="wow fadeInDown" data-wow-delay="0.2s"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_create_account'))?></h3>
			...
			<form action="<?php echo CONFIG_PATH_SITE; ?>register_process.do" method="post" name="frm_reg" id="frm_reg" class="formSkin frmValidate">
					...
					<p class="form-group">
						<div class="row">
							...
							<div class="col-sm-6">
								<label><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_confirm_password'))?>*</label>
                    ...
                    <p class="form-group">
						<div class="row">
							...
							<div class="col-sm-6">
								<label><?php echo $admin->wordTrans($admin->getUserLang(),'City'); ?></label>
                     ...
                     <p class="form-group">
						<div class="row">
							<div class="col-sm-6">
								<label><?php echo $admin->wordTrans($admin->getUserLang(),'Phone'); ?></label>
					...
					<p class="form-group">
						<div class="row">
							<div class="col-sm-4">
								...
								<u><a href='javascript: refreshCaptcha();'><?php echo $admin->wordTrans($admin->getUserLang(),"Can't read the image? click here to refresh"); ?></a></u></label>
								
								<input name="captchaCode" type="text" class="form-control required" id="captchaCode" required />
							</div>
							<div class="col-sm-8 text-right">
								<br /><br /><br />
								<input type="submit" value="<?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_create_account'))?>" class="btn btn-danger btn-lg" />
								<span class="help-block"><?php echo $admin->wordTrans($admin->getUserLang(),'Already has a account'); ?> <a href="<?php echo CONFIG_PATH_SITE;?>sign-in.html"><?php echo $admin->wordTrans($admin->getUserLang(),'click here to login'); ?></a></span>
							</div>
						</div>
					</p>
					<p class="form-group">
