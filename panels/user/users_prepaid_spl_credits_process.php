<?php
	...
	$sql = 'delete from ' . PREPAID_LOG_SPL_CREDITS_RESELLER . ' where user_id=' . $user_id;
	$mysql->query($sql);
	...
	foreach($ids as $id)
	{
		...
		{
			$sql = 'insert into ' . PREPAID_LOG_SPL_CREDITS_RESELLER . '
						(user_id, log_id, amount,reseller_id)
						values('
