...
$qrydata = $mysql->query($sql);
                            if ($mysql->rowCount($qrydata) > 0) {
                                ...
                                $userimg = $rows[0]['img'];
                                 $userimg=CONFIG_PATH_SITE.'images/'.$userimg;
                            }
...
<div class="col-lg-10">
    <div class="card-box">
        <h4 class="m-t-0 m-b-20 header-title"><b><?php echo $admin->wordTrans($admin->getUserLang(),'Chat'); ?></b><span style="float: right"> <select name="days" id="days" onchange="okok();">
            <option <?php echo (($daysold == 7) ? 'selected="selected"' : '')?> value="7">7 <?php echo $admin->wordTrans($admin->getUserLang(),'Days'); ?></option>
            <option <?php echo (($daysold == 14) ? 'selected="selected"' : '')?> value="14">14 <?php echo $admin->wordTrans($admin->getUserLang(),'Days'); ?></option>
            <option <?php echo (($daysold == 30) ? 'selected="selected"' : '')?> value="30">30 <?php echo $admin->wordTrans($admin->getUserLang(),'Days'); ?></option>
              <option <?php echo (($daysold == 1000) ? 'selected="selected"' : '')?> value="1000"><?php echo $admin->wordTrans($admin->getUserLang(),'All Days'); ?></option>
        </select></span></h4>
    ...
    echo $chat_converstaion;
            ...
            <div class="row">
                <div class="col-sm-9 chat-inputbar">
                    <input type="text" class="form-control chat-input" placeholder="<?php echo $admin->wordTrans($admin->getUserLang(),'Enter your text'); ?>">
                </div>
                <div class="col-sm-3 chat-sendd">
                    <button type="submit" class="btn btn-md btn-info btn-block waves-effect waves-light" onclick="addMSG();"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_Send')); ?></button>
