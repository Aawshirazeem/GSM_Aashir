...
<form action="<?php echo CONFIG_PATH_SITE_USER; ?>imei_submit_process.do" method="post" id="testAjax">
    <div class="row hidden" id="loadingPanel" >
        <div class="col-md-8 col-md-offset-2">
            ...
            <!-- Progress Bar -->
            <h3 class="text-center" id="h1Wait"><i class="fa fa-spinner fa-pulse fa-3x fa-fw margin-bottom"></i><?php $lang->prints('lbl_Please_wait_Your_Order_is_Processing'); ?></h3>

            <!-- / Progress Bar -->	


            <!-- Message after successfull submission -->
            <h1 class="text-center" id="h1Done"><i class="fa fa-check fa-large"></i> <?php $lang->prints('lbl_Done'); ?></h1>
            <div class="text-center" id="panelButtons">
                <a href="<?php echo CONFIG_PATH_SITE_USER ?>imei_submit.html" class="btn btn-primary"><i class="icon-ok-sign"></i> <?php $lang->prints('lbl_Submit_more'); ?></a>
                <a href="<?php echo CONFIG_PATH_SITE_USER ?>imei.html?type=pending" class="btn btn-default"><?php $lang->prints('lbl_Pending_IMEI_orders'); ?></a>
            </div>
            <!-- / Message after successfull submission -->


            <!-- Error Message -->
            <div class="alert alert-danger" id="h1Error"><i class="icon-remove icon-large"></i> <span id="h1ErrorText"><?php $lang->prints('lbl_There_is_some_unexpected_error!'); ?></span></div>
            <div class="text-center" id="panelButtonsCredits">
                <a href="<?php echo CONFIG_PATH_SITE_USER ?>imei_submit.html" class="btn btn-default"><i class="icon-refresh"></i> <?php $lang->prints('lbl_Try_again'); ?></a>
                <a href="<?php echo CONFIG_PATH_SITE_USER ?>credits_purchase.html" class="btn btn-primary"><i class="icon-back"></i> <?php $lang->prints('lbl_Request_Credits'); ?></a>
            </div>
            <!-- / Error Message -->
            ...
            <div class="text-muted" id="lblDone">
                <h2><?php $lang->prints('lbl_Done_IMEI(s)'); ?></h2>
            </div>
            <div class="text-warning" id="lblDuplicate">
                <h2><?php $lang->prints('lbl_Duplicate_IMEI(s)'); ?></h2>
            </div>
            <div class="text-danger" id="lblInvalid">
                <h2><?php $lang->prints('lbl_Invalid_IMEI(s)'); ?></h2>
            </div>
        </div>
    </div>
    ...
    <div class="row" id="real_form">
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><?php $lang->prints('lbl_order_new_imei(s)'); ?></div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>
                            <?php $lang->prints('com_unlocking_tool'); ?>
...
<!--                        <select name="tool" class="form-control chosen-select" id="tool" placeholder="Select">-->
                            ...
                            <option value=""><?php $lang->prints('lbl_select_tool'); ?></option>
                            <?php
                            $sql = 'select
                        ...
                        <p class="help-block"><?php $lang->prints('lbl_choose_the_tool_that_best_suits_your_locked_moible_phone'); ?></p>
                    </div>
...
<div class="form-group">
                    <label><?php $lang->prints('lbl_Customer_Note'); ?></label>
                    <input name="remarks" id="remarks" type="text" class="form-control" value="" />
                </div>

                <button type="submit" class="btn btn-success"><i class="icon-ok-sign"></i><?php $lang->prints('lbl_Submit_&_Continue'); ?></button>
                </div> <!-- / panel-body -->
            </div> <!-- / panel -->
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading"><?php $lang->prints('lbl_Description'); ?></div>
                <div class="panel-body">
                    <div id="toolDetails" class="row hidden">
                        <div class="form-group <?php echo (($row['imei_type'] == '0') ? ' hidden' : ''); ?>">
                            ...
                            <p class="help-block"><?php $lang->prints('lbl_the_serial_number_of_the_mobile_phone_to_unlock'); ?>.</p>
                        </div>
                        <div class="form-group <?php echo (($row['imei_type'] == '1') ? ' hidden' : ''); ?>">
                            <label><?php $lang->prints('com_imeis'); ?></label>
                            <textarea name="imeis" id="imeis" class="form-control" rows="5" ></textarea>
                            <p class="help-block"><?php $lang->prints('lbl_the_serial_number_of_the_mobile_phone_to_unlock2'); ?></p>
                        </div>

                        <div class="form-group">
                            <label><?php $lang->prints('lbl_brand'); ?></label>
                            <select name="brand" class="form-control" id="brand">
                                <option value=""><?php $lang->prints('lbl_select_brand'); ?></option>
                            </select>
                            <img src="<?php echo CONFIG_PATH_IMAGES; ?>wait.gif" alt="Please wait..." height="16" width="16" class="hidden" id="loadIndBrand" />
                        </div>
                        <div class="form-group">
                            <label><?php $lang->prints('com_model'); ?></label>
...
<!--    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading"><?php $lang->prints('lbl_other_Info'); ?></div>
            <div class="panel-body" id="comehere">
                ...
                <div class="form-group">
                    <label><?php $lang->prints('lbl_remarks'); ?></label>
                    <input name="remarks" id="remarks" type="text" class="form-control" value="" />
                </div>
