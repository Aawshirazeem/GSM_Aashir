...
<div class="row">
		<div class="col-lg-12">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo $admin->wordTrans($admin->getUserLang(),$lang->prints('lbl_Prepaid_Log_Settings')); ?></li>
...
<!--
	...
	<div id="tabs-1" class="tab-pane active">
		...
		<div id="imei_spl_credits" <?php echo (($row['service_imei'] != '1') ? 'style="display:none"' : '');?>>
			<form action="<?php echo CONFIG_PATH_SITE_USER; ?>users_prepaid_spl_credits_process.do" enctype="multipart/form-data" method="post">
          ...
          $sql_spl_imei = 'select
											...
											left join ' . PREPAID_LOG_SPL_CREDITS_RESELLER . ' plscr on(plscr.user_id = ' . $id . ' and plscr.log_id=plm.id)
