...
<div class="container gsmColl">
    <h3 class="wow fadeInDown" data-wow-delay="0.2s">File Service</h3><br>
    <div class="clearfix">
...
//get defual currency
        ...
        $sql = 'select
										fsm.*,
										if(' . $price . ' =1, fsad.amount,"0") as amount,
										cm.prefix, cm.suffix
									from ' . FILE_SERVICE_MASTER . ' fsm
									left join ' . CURRENCY_MASTER . ' cm on(cm.id = ' . $cur . ')
									left join ' . FILE_SERVICE_AMOUNT_DETAILS . ' fsad on(fsad.service_id=fsm.id and fsad.currency_id = ' . $cur . ')
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#1">
                       <b>Main Group</b> <i class="fa fa-chevron-down pull-right"></i>
                    </a>
                </h4>
            </div><div id="1" class="panel-collapse collapse">
    ...
    <tr class="commentlist">
       ...
       <th width="200">Delivery Time</th>
            ...
            foreach ($rows as $pro) {
                ...
                echo '<td>' . $pro['id'] . '</td>';
                echo '<td class="searchme"><b>' . $pro['service_name'] . '</b></td>';
                if ($price == 1)
